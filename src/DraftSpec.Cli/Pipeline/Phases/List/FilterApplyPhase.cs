...
/// <para><b>Optional:</b> <c>Items[Filter]</c>, <c>Items[FocusedOnly]</c>, <c>Items[PendingOnly]</c>, <c>Items[SkippedOnly]</c></para>
...
public class FilterApplyPhase : ICommandPhase
{
        ...
        CancellationToken ct)
    {
        ...
        // Apply filters
        var filteredSpecs = ApplyFilters(allSpecs, focusedOnly, pendingOnly, skippedOnly, filter);
